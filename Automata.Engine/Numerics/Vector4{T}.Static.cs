...
namespace Automata.Engine.Numerics
{
    public readonly partial struct Vector4<T> where T : unmanaged
    {
        ...
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static Vector4<T> And(Vector4<T> a, Vector4<T> b) => System.Numerics.Vector.BitwiseAnd(a.AsVector(), b.AsVector()).AsVector4();

        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static Vector4<T> Or(Vector4<T> a, Vector4<T> b) => System.Numerics.Vector.BitwiseOr(a.AsVector(), b.AsVector()).AsVector4();
        ...
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        private static Vector4<bool> BooleanReduction<TType>(Vector128<TType> a) where TType : unmanaged
        {
            ...
            {
                return Sse2.PackSignedSaturate(a.As<TType, short>(), Vector128<short>.Zero).AsVector4<sbyte, bool>();
            }
            else if ((typeof(TType) == typeof(sbyte)) || (typeof(TType) == typeof(byte)))
            {
                return a.AsVector4<TType, bool>();
            }
        ...
        public static Vector4<bool> NotEquals(Vector4<T> a, Vector4<T> b)
        {
            ...
            else if (typeof(T) == typeof(double))
            {
                return new Vector4<bool>(
                    ...
                    a.W.Coerce<T, double>() != b.W.Coerce<T, double>());
            }
            else
            {
                Vector.ThrowNotSupportedType();
        ...
        private static Vector4<bool> GreaterThanOrEqual(in Vector4<T> vector4, in Vector4<T> vector5) { throw new System.NotImplementedException(); }
        private static Vector4<bool> LessThanOrEqual(in Vector4<T> vector4, in Vector4<T> vector5) { throw new System.NotImplementedException(); }
