...
namespace Automata.Engine.Tests.Numerics.Vector3_Types
{
    public class Short
    {
        private static readonly Vector3<short> _A = new Vector3<short>(0, 10, 10);
        private static readonly Vector3<short> _B = new Vector3<short>(0, 0, 20);

        [Fact]
        public void AddOperator()
        {
            Vector3<short> result = _A + _B;
        ...
        {
            Vector3<short> result = Vector3<short>.Abs(new Vector3<short>(1));
