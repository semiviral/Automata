...
namespace Automata.Engine.Tests.Numerics.Vector3_Types
{
    public class ULong
    {
        private static readonly Vector3<ulong> _A = new Vector3<ulong>(0, 10, 10);
        private static readonly Vector3<ulong> _B = new Vector3<ulong>(0, 0, 20);

        [Fact]
        public void AddOperator()
        {
            Vector3<ulong> result = _A + _B;
        ...
        {
            Vector3<ulong> result = Vector3<ulong>.Abs(new Vector3<ulong>(1));
