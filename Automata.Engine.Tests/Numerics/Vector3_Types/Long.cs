...
namespace Automata.Engine.Tests.Numerics.Vector3_Types
{
    public class Long
    {
        private static readonly Vector3<long> _A = new Vector3<long>(0, 10, 10);
        private static readonly Vector3<long> _B = new Vector3<long>(0, 0, 20);

        [Fact]
        public void AddOperator()
        {
            Vector3<long> result = _A + _B;
        ...
        {
            Vector3<long> result = Vector3<long>.Abs(new Vector3<long>(1));
