...
namespace Automata.Engine.Tests.Numerics.Vector2_Types
{
    public class Byte
    {
        private static readonly Vector2<byte> _A = new Vector2<byte>(0, 10);
        private static readonly Vector2<byte> _B = new Vector2<byte>(0, 0);

        [Fact]
        public void AddOperator()
        {
            Vector2<byte> result = _A + _B;
        ...
        {
            Vector2<byte> result = Vector2<byte>.Abs(new Vector2<byte>(1));
